...
export default function GraficoRelatorio({
  ...
  if (!possuiDados) {
    return (
      <div className="flex h-72 items-center justify-center rounded-xl border border-dashed border-zinc-800 bg-black">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-zinc-600">
            Selecione outro mês ou cadastre novas movimentações.
          </p>
        </div>
      </div>
    );
